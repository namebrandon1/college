  ...
  <div align="center">
  <form method="post" action="checklogin_admi.php"  style="width: 70%;align-self: center;background-color: transparent;">
        <div class="imgcontainer">
          <img src="pic/admin.png" alt="Avatar" class="avatar" style="align-items: center;">
        </div>
