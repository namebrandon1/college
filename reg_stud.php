  ...
  <div align="center">
  <form  method="post" action="register_stud.php" style="width: 70%;align-self: center;background-color: transparent;">
        <div class="imgcontainer">
          <img src="pic/student.png" alt="Avatar" class="avatar" style="align-items: center;">
        </div>
        ...
        <div class="container">
          ...
          <input type="submit" style="background-color: orange"><h2>Register</h2></input>
       </div>
    </form>
