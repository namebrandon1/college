  ...
  <div align="center">
  <form action="/action_page.php" style="width: 70%;align-self: center;background-color: transparent;">
        <div class="imgcontainer">
          <img src="pic/chef.png" alt="Avatar" class="avatar" style="align-items: center;">
        </div>
